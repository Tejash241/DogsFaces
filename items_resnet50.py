...
train_loader, val_loader, test_loader = item_loader.create_loaders(batch_size, 
...
for epoch in range(num_epochs):
	...
	torch.save(model.state_dict(), './item_models/epoch{}_validloss{}_validacc{}'.format(epoch, np.mean(valid_loss), np.mean(valid_acc)))
